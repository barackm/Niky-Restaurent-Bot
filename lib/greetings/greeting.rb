class Greeting
  ...
  def receive_greetings(input)
    values = ['how are you', 'are you okay', 'are you cool', 'how are you', 'how are you doing', 'are you okay',
  ...
  def get_my_creator(input)
    values = ['who created', 'creates', 'made', 'who is your creator','author', 'created', 'who created you', 'creator',
